...
public:
    ...
    void OnUpdate() noexcept override {
        ...
        m_Sprite2.SetPosition({50, 0});
        m_Sprite3.SetPosition({2 * 50, 0});
        m_Sprite4.SetPosition({3 * 50, 0});
        m_Sprite5.SetPosition({4 * 50, 0});
        m_Sprite6.SetPosition({5 * 50, 0});
        m_Sprite7.SetPosition({6 * 50, 0});
        m_Sprite8.SetPosition({7 * 50, 0});
        m_Sprite9.SetPosition({8 * 50, 0});
        m_Sprite10.SetPosition({9 * 50, 0});
        m_Sprite11.SetPosition({10 * 50, 0});
        m_Sprite12.SetPosition({11 * 50, 0});
        m_Sprite13.SetPosition({12 * 50, 0});
        m_Sprite14.SetPosition({13 * 50, 0});
        m_Sprite15.SetPosition({14 * 50, 0});
        m_Sprite16.SetPosition({15 * 50, 0});
        m_Sprite17.SetPosition({16 * 50, 0});
        m_Sprite18.SetPosition({17 * 50, 0});
        m_Sprite19.SetPosition({18 * 50, 0});
        m_Sprite20.SetPosition({19 * 50, 0});
        m_Sprite22.SetPosition({20 * 50, 0});
        m_Sprite23.SetPosition({21 * 50, 0});
        m_Sprite21.SetPosition({22 * 50, 0});
        m_Sprite24.SetPosition({23 * 50, 0});
        m_Sprite25.SetPosition({24 * 50, 0});
        m_Sprite26.SetPosition({25 * 50, 0});
        m_Sprite27.SetPosition({26 * 50, 0});
        m_Sprite28.SetPosition({27 * 50, 0});
        m_Sprite29.SetPosition({28 * 50, 0});
        m_Sprite30.SetPosition({29 * 50, 0});
        m_Sprite31.SetPosition({30 * 50, 0});
        m_Sprite32.SetPosition({31 * 50, 0});
        m_Sprite33.SetPosition({32 * 50, 0});
        m_Sprite34.SetPosition({33 * 50, 0});
