...
public:
  ...
  void OnAttach() noexcept override {
    ...
    Bald::Events::EventBus::Subscribe<Bald::Events::KeyPressedEvent>(
        [&](const Bald::Events::KeyPressedEvent &e) {
          if (e.GetKeyCode() == BALD_KEY_W) {
            ...
            Bald::Events::EventBus::Emit<Bald::Events::WindowClosedEvent>();
          }
...
class EventsExample : public Bald::Application {
  GENERATE_BODY(DERIVED)
public:
  EventsExample() { PushLayer<ExampleLayer>(); }
