...
namespace Bald {
    ...
    std::vector<FunctionHandler < WindowClosedEvent>*> WindowClosedEvent::callbacks;
    std::vector<AsyncFunctionHandler < WindowClosedEvent>*> WindowClosedEvent::async_callbacks;
}