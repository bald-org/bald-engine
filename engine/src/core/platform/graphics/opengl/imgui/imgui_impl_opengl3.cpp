...
//#include <GLFW/gl3w.h>    // Needs to be initialized with gl3wInit() in user's code
#include "glad/glad.h"
            ...
            else
            {
                ...
                if (clip_rect.x < static_cast<float>(fb_width) && clip_rect.y < static_cast<float>(fb_height) && clip_rect.z >= 0.0f && clip_rect.w >= 0.0f)
                {
                    ...
                    if (clip_origin_lower_left)
                        glScissor(static_cast<int>(clip_rect.x), static_cast<int>(fb_height - static_cast<int>(clip_rect.w)), static_cast<int>(clip_rect.z - clip_rect.x), static_cast<int>(clip_rect.w - clip_rect.y));
                    else
