...
TEST(FileManager, GoodSmallFileOpening) { //NOLINT
    ...
    std::string file_result = Bald::Utils::FileManager::ReadFile("../engine/test_file_manager.txt",
                                                                 Bald::Utils::FileManager::Size::SMALL_FILE);
...
TEST(FileManager, GoodBigFileOpening) { //NOLINT
    ...
    std::string file_result = Bald::Utils::FileManager::ReadFile("../engine/test_file_manager.txt",
                                                                 Bald::Utils::FileManager::Size::BIG_FILE);
...
TEST(FileManager, WrongSmallFileOpening) { //NOLINT
    ...
    std::string file_result = Bald::Utils::FileManager::ReadFile("no_such_file.cpp",
                                                                 Bald::Utils::FileManager::Size::SMALL_FILE);
